...
public class Profile_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Upcoming_url = "https://ecse321-group7.herokuapp.com/trips/search?driverid=" + myUserid;
                ...
                try {
                    ...
                    if (response.isNull(0)) {   // If null then show dialog for not found
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            CustomListView item = new CustomListView(i, data.getString("departure_date"),
                                    data.getString("seats_available") + " Seats Left",
                                    "At " + data.getString("departure_time"),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.homeMenuButton:
                Intent GoToCreate = new Intent(Profile_page.this,Trip_Create.class);
                GoToCreate.putExtra("userid",myUserid);
